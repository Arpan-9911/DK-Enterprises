...
let afirst = document.querySelector(".afirst");
let i3 = document.querySelector("#i3");
document.querySelector(".qfirst").onclick = () =>{
    afirst.classList.toggle("active");
    i3.classList.toggle("active");
    asecond.classList.remove("active");
    i4.classList.remove("active");
}
let asecond = document.querySelector(".asecond");
let i4 = document.querySelector("#i4");
document.querySelector(".qsecond").onclick = () =>{
    asecond.classList.toggle("active");
